...
- `/company/[id]` 公司研究画布，覆盖美股 / 港股 / A 股三个市场；576 家公司已完成上线（全库 Phase 1 达成率达 97.6%），目录页严格以 `metadata.onboardPhase >= 1` 为准绳，待完善标的精准收敛至 14 家非经营性特殊标的（破产/SPAC/基金等）；Onboard 自动化接入管线原生支持 SEC 官方挂牌探查与 10-Q 季度财报 / S-1 招股书级联降级
