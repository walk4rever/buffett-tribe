...
数据来自两层：
1. **Fact 层**：财务数据（美股 EDGAR XBRL / 港股 A 股 akshare 三大报表，支持「年度 (FY) / 单季 (Quarterly)」无缝切换，顶部核心卡片支持滑动 4 季 TTM 动态追踪：PE-TTM、PS-TTM、ROE-TTM、FCF-TTM）、价格（Yahoo Finance 历史价格走势：日K/周K/月K/季K平滑聚合、前复权/不复权切换、1年/3年/全部跨度快速定位、统一右侧坐标轴与防误触手势）、参考资料（三大市场年报、10-Q、中报、季报原文归档至 R2，支持 HTML/PDF 双引擎通用阅读器与「AI 解读」浮窗交互）
